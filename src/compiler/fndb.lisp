...
(defknown %signed-multiply-high (sb!vm:signed-word sb!vm:signed-word)
    sb!vm:signed-word
    (movable foldable flushable))
...
(defknown sb!kernel::%signed-multiply-and-add-high
    (sb!vm:signed-word sb!vm:signed-word sb!vm:signed-word)
    sb!vm:signed-word
    (movable foldable flushable))
